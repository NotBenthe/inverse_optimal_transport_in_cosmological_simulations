...
pathpi = "./results/actual_ma/pi-n" + str(n_boxes) + ".csv"
pathmunu = "./results/actual_ma/munu-n" + str(n_boxes) + ".csv"
...
filenamepi = "./results/actual_ma/c-n" + str(n_boxes) + "-new.csv"
with open(filenamepi, 'w') as f:
    np.savetxt(f, c, delimiter=',')

filenamemunu = "./results/actual_ma/ab-n" + str(n_boxes) + "-new.csv"
